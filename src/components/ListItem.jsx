...
export default function ListItem({
  ...
  return (
    <li className="group transition-all w-full px-0 py-4 relative z-10 cursor-pointer mt-10">
      <article
        itemType={`${company ? "https://schema.org/JobPosting" : "https://schema.org/SoftwareSourceCode"}`}
      >
          ...
          <div className="flex-grow flex-shrink basis-[25%] mb-2 lg:mb-0">
            {date ? (
              ...
              <img
                ...
                loading="lazy"
                alt={`${title} project screenshot by Mark Ponce`}
              ...
              >
                ...
                {company === "Always Open Commerce" ? (
                  <>
                    ...
                    <li className="mt-2">
                      <h4 className="text-muted font-semibold uppercase text-xs flex justify-start items-center before:content-[''] before:w-10 before:mr-2 before:h-[1.5px] before:bg-gray-500">
